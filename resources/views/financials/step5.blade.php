<h3 class="text-2xl font-bold mb-6">Télécharger Bilan Financier</h3>
<section>
    <div class="grid grid-cols-1 gap-y-8 mt-20 items-center justify-center w-full">
        ...
        <div class="grid grid-cols-3 items-center gap-x-4">
            <p id="error-message" class="text-red-500 mt-2 hidden col-start-2">Veuillez télécharger un fichier avant de continuer.</p>
        </div>
    </div>
</section>
