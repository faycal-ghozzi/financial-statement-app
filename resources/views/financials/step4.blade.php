    ...
    <div class="grid grid-cols-1 gap-y-8">
        @foreach($resultats as $resultat)
            ...
            <div class="grid grid-cols-3 items-center gap-x-4">
                ...
                <input type="text" name="actifs[{{ $resultat->id }}][n-1]"
                       id="actifs_{{ strtolower(str_replace(' ', '_', $resultat->label)) }}_n-1"
                ...
                <input type="text" name="actifs[{{ $resultat->id }}][n]" 
                       id="actifs_{{ strtolower(str_replace(' ', '_', $resultat->label)) }}_n"
