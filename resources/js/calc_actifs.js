...
function calcActifsImmobilises(){
    $('[data-role^="Actifs Immobilises"]').on('blur', function() {
        ...
        const immobilisations_incorporelles_n_1 = parseFloat(cleanNumber($('#actifs_amortissements_-_immobilisations_incorporelles_n-1_result').val())) || 0;
        const immobilisations_corporelles_n_1 = parseFloat(cleanNumber($('#actifs_amortissements_-_immobilisations_corporelles_n-1_result').val())) || 0;
        const immobilisations_financieres_n_1 = parseFloat(cleanNumber($('#actifs_provisions_-_immobilisations_financières_n-1_result').val())) || 0;
        ...
        const immobilisations_incorporelles_n = parseFloat(cleanNumber($('#actifs_amortissements_-_immobilisations_incorporelles_n_result').val())) || 0;
        const immobilisations_corporelles_n = parseFloat(cleanNumber($('#actifs_amortissements_-_immobilisations_corporelles_n_result').val())) || 0;
        const immobilisations_financieres_n = parseFloat(cleanNumber($('#actifs_provisions_-_immobilisations_financières_n_result').val())) || 0;
...
function calcANC(){
    $('[data-role="Actif non courant"],[data-role^="Actifs Immobilises"]').on('blur', function(){
        ...
        const actifs_total_actifs_immobilisés_n_1 = parseFloat(cleanNumber($('#actifs_total_actifs_immobilisés_n-1').val())) || 0;
        const actifs_autres_actifs_non_courants_n_1 = parseFloat(cleanNumber($('#actifs_autres_actifs_non_courants_n-1').val())) || 0;

        const total_anc_n_1 = actifs_total_actifs_immobilisés_n_1 + actifs_autres_actifs_non_courants_n_1;

        const actifs_total_actifs_immobilisés_n = parseFloat(cleanNumber($('#actifs_total_actifs_immobilisés_n').val())) || 0;
        const actifs_autres_actifs_non_courants_n = parseFloat(cleanNumber($('#actifs_autres_actifs_non_courants_n').val())) || 0;
...
function calcAC(){
    ...
    $('[data-role^="Actif Courant"').on('blur', function(){
        ...
        $('#actifs_total_des_actifs_courants_n-1').val(formatNumber(sum_n_1));
        $('#actifs_total_des_actifs_courants_n').val(formatNumber(sum_n));
    })
}
